...
exports.UaiRangoController = void 0;
...
class UaiRangoController {
    async getTokenByTenant(req, res) {
        ...
        try {
            ...
            const token = await uaiService.getValidToken(empresa.id, empresa.configUaiRango);
            ...
            for (const evento of listaEventos) {
                try {
                    ...
                    if (eventosParaConfirmar.length > 0) {
                        ...
                        await uaiService.confirmarRecebimento(empresa.id, empresa.configUaiRango, eventosParaConfirmar);
                    }
    ...
    async confirmarProcessamentoPelaRota(req, res) {
        try {
            const { tenantId } = req.params;
            ...
            await uaiService.confirmarRecebimento(empresa.id, empresa.configUaiRango, eventIds);
...
exports.UaiRangoController = UaiRangoController;
